...
namespace Example
{
    public class GetSevSequenceExample
    {
        public void main()
        {
            ...
            var apiInstance = new SevSequenceApi();
            ...
            {
                Debug.Print("Exception when calling SevSequenceApi.GetSevSequence: " + e.Message );
            }
        }
    }
}
