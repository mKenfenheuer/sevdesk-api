# SevDeskApi.Api.ObjectViewedApi
...
namespace Example
{
    public class GetObjectViewedExample
    {
        public void main()
        {
            ...
            var apiInstance = new ObjectViewedApi();
            var limit = 56;  // int? | Limits the number of entries returned. Default is 100 (optional)  (default to 100)
            var offset = 56;  // int? | Set the index where the returned objects viewed start. Default is 0 (optional)  (default to 0)
            ...
            {
                Debug.Print("Exception when calling ObjectViewedApi.GetObjectViewed: " + e.Message );
            }
        }
    }
}
